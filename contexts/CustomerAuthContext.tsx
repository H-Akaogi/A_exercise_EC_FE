...
import type { CustomerLoginRequest } from "@/models/CustomerAuth";
...
export const CustomerAuthProvider = ({
  ...
  const login = useCallback(
    async (request: CustomerLoginRequest): Promise<void> => {
      const authState = await service.login(request);
  ...
  const getAccessToken = useCallback(
    (): string | null => service.getAccessToken(),
    [service],
  );
