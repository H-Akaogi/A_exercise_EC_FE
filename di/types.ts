...
export const TYPES = {
    ...
    ICustomerAuthRepository: Symbol.for("ICustomerAuthRepository"),
    ICustomerAuthSessionStore: Symbol.for("ICustomerAuthSessionStore"),
    // サービス(ユースケース)層
    ...
    ICustomerAuthService: Symbol.for("ICustomerAuthService"),
};
