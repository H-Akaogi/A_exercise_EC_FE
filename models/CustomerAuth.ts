 ...
 * ログイン入力値に誤りがある場合のエラー。
 */
export class CustomerLoginValidationError extends Error {
  public readonly fieldErrors: CustomerLoginFieldErrors;

  constructor(fieldErrors: CustomerLoginFieldErrors) {
