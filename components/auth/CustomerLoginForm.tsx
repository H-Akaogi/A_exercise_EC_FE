...
export const CustomerLoginForm = () => {
  ...
  const { login, sessionMessage } = useCustomerAuth();
  ...
  const displayedErrorMessage = errorMessage || sessionMessage || "";
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (error instanceof CustomerLoginValidationError) {
        ...
        <form method="post" noValidate onSubmit={handleSubmit}>
          <div className="mb-5">
            ...
            <Input
              ...
              aria-invalid={Boolean(fieldErrors.mailAddress)}
              aria-describedby={
                fieldErrors.mailAddress ? "mailAddress-error" : undefined
              }
              onChange={(event) => {
